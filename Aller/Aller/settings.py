"""
Django settings for Aller project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'JAa8d9a78ywa8dhAWIUDNINdwaidh87awyd8a7')
...
WSGI_APPLICATION = 'Aller.wsgi.application'
...
CHANNEL_LAYERS = {
    "default": {
        "ROUTING": "Aller.routing.channel_routing",
